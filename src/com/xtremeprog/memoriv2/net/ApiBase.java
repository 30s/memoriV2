...
package com.xtremeprog.memoriv2.net;
...
import com.xtremeprog.memoriv2.net.ApiRequest.Parameter;
...
public class ApiBase {
    ...
    private HttpUriRequest createHttpRequest(ApiRequest request,
        ...
        // String baseUrl = request.getServerType() == ApiRequest.API ? Preferences.getAPIServer(this.context) : Preferences.getUploadServer(context);
